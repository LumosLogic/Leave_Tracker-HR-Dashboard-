...
import {
  ...
  Bell, Fingerprint, Link2, ScrollText, X, Search, Play, IndianRupee, Terminal,
...
const BIOMETRIC_ITEMS = [
  ...
  { to: '/biometric/live-logs', label: 'Live Logs', Icon: Terminal,    adminOnly: true, featureKey: 'biometric' },
];
